...
// let {db, getDoc, doc} = await import('../../shared/firebase');
const initialState = {
  fix: {},
  isLoading: false,
  isError: false,
...
// export const __editFix = createAsyncThunk('editFix', async (payload, thunkAPI) => {
//   try {
//     const postRef = doc(db, 'fixs', payload);
//     const editpost = await updateDoc(postRef, payload);
//     thunkAPI.dispatch(__getFix);
//     return thunkAPI.fulfillWithValue(editpost.data());
//   } catch (err) {
//     return thunkAPI.rejectWithValue(err);
//   }
// });
